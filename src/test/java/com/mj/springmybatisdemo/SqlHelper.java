...
public class SqlHelper {
     ...
     * @return
     */
    public static String getMapperSql(Configuration configuration,Object mapper, String methodName, Object... args) {
       // MetaObject metaObject = SystemMetaObject.forObject(mapper);
       // SqlSession session = (SqlSession) metaObject.getValue("h.sqlSession");
       Class mapperInterface = mapper.getClass();//(Class) metaObject.getValue("h.mapperInterface");
        String fullMethodName = mapperInterface.getCanonicalName() + "." + methodName;
        if (args == null || args.length == 0) {
            return getNamespaceSql(configuration, fullMethodName, null);
        } else {
            return getMapperSql(configuration, mapperInterface, methodName, args);
        }
    }
     ...
     * @return
     */
    public static String getMapperSql(Configuration configuration, String fullMapperMethodName, Object... args) {
        if (args == null || args.length == 0) {
     ...
     * @return
     */
    public static String getMapperSql(Configuration configuration, Class mapperInterface, String methodName, Object... args) {
       ...
       // MapperMethod mapperMethod=  new MapperMethod(mapperInterface, method, configuration);
        MapperMethod.MethodSignature methodSignature=  new MapperMethod.MethodSignature(configuration, mapperInterface, method);
      //  mapperMethod.
   ...
   /*    Map params = new HashMap();
     ...
     * @return
     */
    public static String getNamespaceSql(Configuration configuration, String namespace) {
